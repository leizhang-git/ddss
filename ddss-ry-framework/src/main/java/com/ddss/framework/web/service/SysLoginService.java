...
public class SysLoginService {
    ...
    public String login(String username, String password, String code, String uuid) {
        ...
        try {
            ...
            if (e instanceof BadCredentialsException) {
                AsyncManager.me().execute(AsyncFactory.recordLogininfor(username, SystemConstants.LOGIN_FAIL, MessageUtils.message("user.password.not.match")));
        ...
        AsyncManager.me().execute(AsyncFactory.recordLogininfor(username, SystemConstants.LOGIN_SUCCESS, MessageUtils.message("user.login.success")));
    ...
    public void validateCaptcha(String username, String code, String uuid) {
        ...
        if (captchaEnabled) {
            ...
            if (captcha == null) {
                AsyncManager.me().execute(AsyncFactory.recordLogininfor(username, SystemConstants.LOGIN_FAIL, MessageUtils.message("user.jcaptcha.expire")));
                throw new CaptchaExpireException();
            }
            redisCache.deleteObject(verifyKey);
            if (!code.equalsIgnoreCase(captcha)) {
                AsyncManager.me().execute(AsyncFactory.recordLogininfor(username, SystemConstants.LOGIN_FAIL, MessageUtils.message("user.jcaptcha.error")));
    ...
    public void loginPreCheck(String username, String password) {
        ...
        if (StringUtils.isEmpty(username) || StringUtils.isEmpty(password)) {
            AsyncManager.me().execute(AsyncFactory.recordLogininfor(username, SystemConstants.LOGIN_FAIL, MessageUtils.message("not.null")));
        ...
        if (IpUtils.isMatchedIp(blackStr, IpUtils.getIpAddr())) {
            AsyncManager.me().execute(AsyncFactory.recordLogininfor(username, SystemConstants.LOGIN_FAIL, MessageUtils.message("login.blocked")));
